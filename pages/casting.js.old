      ...
      <main className='max-w-screen-md mx-auto px-4'>
        <section className='relative pt-32'>
          ...
          <div className='mt-8 text-center space-y-3'>
            <p>Imagination Serverでは、約2年ぶりにメンバーを公募することになりました✨</p>
          </div>

          <h1 className='mt-24 text-2xl font-bold text-center'>こんな人を求めています</h1>
          <p className='mt-8'>&emsp;この活動は「いつ、どこからでもディズニーにいける世界」をテーマとして、2016年に誕生したプロジェクトです。<br />メンバーは日本各地からこのビジョンに共感して集まっており、パークを忠実に再現するだけでなく、これまで5,000人近くのユーザーに対し「どこでもディズニー」を提供してきました。<br />まずメンバーにはこのビジョンへの共感を求めていますが、もう一つ意識している特徴として、オンラインプロジェクトであることがあげられます。私たちには、住んでいる地域や年齢、価値観が異なる多様な人がフラットに集まる環境があります。<br />大切なのは、このような多様性に富むオンラインの特性を生かし、それぞれの強みや価値観を持って切磋琢磨しながらビジョンに向かおうとする意欲です。</p>
          <p className='mt-8'>&emsp;とは言っても、私たちのビジョンは抽象的で、正解がありません。代わりにメンバー1人1人が、このビジョンに対して「想い」を持っています。<br />私たちは今、その一人一人の想いから生まれるアイデアや挑戦を通し、私たちなりの解を少しずつ導き出そうとしている最中です。私たちImagination Serverは、このように単にディズニーを再現しているプロジェクトではなく、一人一人が主役となって未だ答えのない問いに挑戦しているプロジェクトです。<br />みなさんの個性あふれる“Imagination”でこの活動がより面白く、インパクトのあるプロジェクトになることを楽しみにしています。</p>
