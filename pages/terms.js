    ...
    <>
      ...
      <SectionWrapper>
        <section className='section prose'>
          <h4>本規約に含まれる内容</h4>
          <p>Imagination Serverの利用に関するもの及び使用している権利に関するものを含みます。</p>
          <h4>1. 規約への同意</h4>
          <p>Imagination Serverに関するサービスに参加、体験をした場合、この規約へ同意したものとみなします。また、規約内容を理解できていないと判断した場合は、Imagination Serverが展開する全てのプログラム及びサービスの利用をお断りします。</p>
          <h4>2. 規約の変更</h4>
          <p>この規約は、事前に予告なくImagination Serverにより変更されます。また、以下に示す団体・企業により変更の要請が行われた場合、それに従い、事前に予告なくImagination Serverにより変更されます。</p>
          <ul>
          ...
          <ul>
            <li>未完成の建造物にはバリアブロックが設置されています。不用意に中に入る等はご遠慮ください。</li>
            <li>万が一違反行為とみなした場合は、以降のご来園をお断りさせていただく場合がありますのでご了承ください。</li>
          </ul>
          <h4>6. プラットフォームでの利用規約について</h4>
          <p>「Minecraft (Bedrock Edition）」の利用規約についてはMojang Studiosの「MINECRAFT 利用規約および エンド ユーザー使用許諾契約書」を確認してください。また、プラットフォームにおいて発生する全ての事象について、Imagination Serverは一切の責任を負わず、全て利用者自身の責任となります。</p>
          <h4>7. 収益について</h4>
          <p>Imagination Serverの活動のうち“東京ディズニーリゾート各施設の再現”において、Imagination Serverの全てのメンバーが収益を得ることはありません。従って、Imagination Serverの大半の活動は非営利目的となります。</p>
          <h4>8. 団体について</h4>
